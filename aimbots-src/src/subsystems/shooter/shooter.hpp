...
public:
    ...
    DJIMotor flywheel1, flywheel2, flywheel3, flywheel4, flywheel5, flywheel6;
    SmoothPID flywheel1PID, flywheel2PID, flywheel3PID, flywheel4PID, flywheel5PID, flywheel6PID;
