...
src::Utils::RefereeHelperTurreted refHelper(drivers(), currentBarrel, 15);
...
BarrelDormantCommand barrelDormantCommand(drivers(), &barrelManager, &refHelper, barrelMovingFlag, barrelCaliDoneFlag);
...
void setDefaultCommands(src::Drivers *) {
    ...
    barrelManager.setDefaultCommand(&barrelDormantCommand);
}
